...
┟─⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🅳.  الـ ـ ـتـ ـ ـنـ ـز يـ ـ ـلات໑⃪࣭۪ٜ݊݊݊݊𑁍ꥈ࣪⬪╮
╭┄─🍂⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🅼🄴🄶🅄🄼🄸🄽໑⃪࣭۪ٜ݊݊݊݊𑁍ꥈ࣪⬪╯
│
├ ⚘݄𖠵⃕⁖𖥔. _*🅃الـعـنـوانـ*_
├» ${yt_play[0].title}
├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┄
├ ⚘݄𖠵⃕⁖𖥔. _*🄿نـشـرتـ*_
├» ${yt_play[0].ago}
...
handler.help = ['شغل2','play2']
handler.command = ['play', 'play2', 'play3', 'play4', 'شغل2']
//handler.limit = 3
