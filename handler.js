...
const msg = {
rowner: '「👑」 *hey لا يمكن استخدام هذه الميزة إلا بواسطة منشئ المحتوى الخاص بي*\n\n> ALI-Maoie.', 
owner: '「👑」 *hey لا يمكن استخدام هذه الوظيفة إلا بواسطة المطور الخاص بي.', 
mods: '「🤴🏻」 *hey لا يمكن استخدام هذه الميزة إلا من قبل المطورين لدي.*', 
premium: '「🍧」 *hey هذه الميزة مخصصة فقط لمستخدمي Premium.', 
group: '「🐢」 *hey لا يمكن تنفيذ هذه الوظيفة إلا في مجموعات.*', 
private: '「🍭」 *hey لا يمكن استخدام هذه الوظيفة إلا في الدردشة الخاصة.*', 
admin: '「👑」 *hey لا يمكن استخدام هذا الأمر إلا من قبل المسؤولين.*', 
botAdmin: '「🚩」 *hey لاستخدام هذه الميزة يجب أن أكون مشرفتا.*', 
unreg: '「🍟」 *¡hey! أنت غير مسجل، قم بالتسجيل لاستخدام هذه الوظيفه*\n\n*/سجل الاسم.العمر*\n\n*_❕ مثلا_* : */.سجل ali.24*',
restrict: '「💫」 *hey تم تعطيل هذه الميزة.*'
}[type];
