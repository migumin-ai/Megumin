...
const msg = {
rowner: '「👑」 *لا يمكن استخدام هذه الميزة función إلا بواسطة منشئ المحتوى الخاص بي*\n\n> David-Chian.', 
owner: '「👑」 *لا يمكن استخدام هذه الوظيفة función إلا بواسطة المطور الخاص بي.', 
mods: '「🤴🏻」 *لا يمكن استخدام هذه الميزة función إلا من قبل المطورين لدي.*', 
premium: '「🍧」 *هذه الميزة función مخصصة فقط لمستخدمي Premium.', 
group: '「🐢」 *لا يمكن تنفيذ هذه الوظيفة funcion إلا في مجموعات.*', 
